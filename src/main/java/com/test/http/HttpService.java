...
public class HttpService {
    ...
    public Map<String, Object> commonService(String serviceUrl, HttpParamers paramers, HttpHeader header) throws Exception{
        String response = service(serviceUrl, paramers, header, true);
        try {
    ...
    public String service(String serviceUrl, HttpParamers paramers, boolean isJson) throws Exception {
        return service(serviceUrl, paramers, null, isJson);
    }
    public String service(String serviceUrl, HttpParamers paramers, HttpHeader header, boolean isJson) throws Exception {
        String url = this.serverUrl + serviceUrl;
        String responseData = "";
        try {
            responseData = HttpClient.doService(url, paramers, header, this.connectTimeout, this.readTimeout, isJson);
        } catch (Exception e) {
